        ...
        <>
            ...
            >
                <div className="max-w-[1200px] mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <motion.button
                        whileTap={{ scale: 0.9 }}
                        className="md:hidden p-2 text-charcoal dark:text-white z-50 relative"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-background-light dark:bg-background-dark z-40 pt-24 px-6 md:hidden"
                    >
